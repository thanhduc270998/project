<div class="col-lg-7 mb-6">
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-0">Số Ngày</th>
                          <th scope="col" class="border-0">Tốc Độ</th>
                          <th scope="col" class="border-0">Loại</th>
                      ...
                      <tbody>
     <?php 
     $query = "SELECT * FROM viplike WHERE username = '".$_SESSION['username']."' ORDER BY id DESC LIMIT 0,3 ";
    ...
    ?>
          <tr>
            ...
            <td> <?php echo $row['time']; ?>  / Lần Cron</td>
            <td> <?php echo $row['camxuc']; ?></td>
