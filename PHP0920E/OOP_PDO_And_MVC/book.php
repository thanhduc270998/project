 ...
 */
// dựa theo OOP -> lấy đối tượng book làm trọng tâm để phân tích thuộc tính/ phương thức có thể có
...
class Book{
    ...
    // khai báo các thuộc tính , có bao nhiêu trường trong bảng -> bấy nhiêu thuộc tính
    public $id; // mã sách
    public $name;
    ...
    // viết câu truy vấn
        $sql_insert = "INSERT INTO books(name,amount) VALUES('$this->name',$this->amount) ";
        // thực thi truy vấn
        $is_insert = mysqli_query($this->connection, $sql_insert);
        return $is_insert;
    }
    //Sửa
